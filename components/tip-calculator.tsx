...
export default function TipCalculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-green-300 to-pink-400">
      {/* Heading for developer info */}
      <h1 className="text-3xl font-bold text-black mb-6">Developed by Zeenat Somroo</h1>
      
      {/* Center the tip calculator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-pink shadow-lg rounded-lg">
        <CardHeader>
          {/* Header with title and description */}
          <CardTitle className="text-xl font-semibold">Tip Calculator</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          ...
          <Button onClick={calculateTip} className="bg-blue-600 text-white hover:bg-blue-700">Calculate</Button>
        </CardContent>
